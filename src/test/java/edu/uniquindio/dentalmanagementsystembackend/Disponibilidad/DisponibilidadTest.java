...
public class DisponibilidadTest {
    ...
    void obtenerFechasDisponibles() {
        try {
            ...
            List<LocalDate> fechasDisponibles = serviciosDisponibilidadDoctor.obtenerFechasDisponibles("111111111", LocalDate.now(), LocalDate.now().plusDays(30));
    ...
    void obtenerHorariosDisponibles() {
        try {
            ...
            List<LocalDate> fechasDisponibles = serviciosDisponibilidadDoctor.obtenerFechasDisponibles("111111111", LocalDate.now(), LocalDate.now().plusDays(7));
            
            if (!fechasDisponibles.isEmpty()) {
                LocalDate fechaPrueba = fechasDisponibles.get(0);
                System.out.println("Usando fecha de prueba: " + fechaPrueba);
                
                List<LocalTime> horariosDisponibles = serviciosDisponibilidadDoctor.obtenerHorariosDisponibles("111111111", fechaPrueba);
